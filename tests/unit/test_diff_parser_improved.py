...
class TestGitLsFiles:
    ...
    @patch("subprocess.run")
    def test_git_ls_files_empty_output(self, mock_run):
...
class TestGitChangedFiles:
    ...
    @patch("subprocess.run")
    def test_git_changed_files_success(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_git_changed_files_failure(self, mock_run):
    ...
    @patch("subprocess.run")
    def test_git_changed_files_empty_output(self, mock_run):
