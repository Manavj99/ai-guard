...
class TestTestGen:
    ...
    def test_main_no_changed_files(self, mock_parse_args, mock_changed_files):
        ...
        mock_parse_args.return_value = Mock(
            event=None, output="tests/unit/test_generated.py"
        )
    ...
    def test_main_with_changed_files(
        self,
        mock_mkdir,
        mock_open,
        mock_parse_args,
        ...
        with patch('builtins.print') as mock_print:
            ...
            mock_print.assert_any_call(
                "[testgen] Generated speculative tests for 1 files"
            )
    ...
    def test_main_custom_output_path(self, mock_parse_args, mock_changed_files):
        ...
        mock_parse_args.return_value = Mock(
            event=None, output="custom/path/test.py"
        )
