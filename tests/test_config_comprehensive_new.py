...
class TestParseConfigValue:
    ...
    def test_parse_config_value_auto(self):
        """Test parsing config value with auto detection."""
    ...
    def test_parse_config_value_invalid_bool(self):
        """Test parsing invalid bool value."""
...
class TestConfig:
    ...
    def test_config_from_dict(self):
        ...
        config_dict = {"min_coverage": 95, "skip_tests": True}
