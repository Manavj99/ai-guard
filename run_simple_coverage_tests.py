#!/usr/bin/env python3
"""Run simplified coverage tests to improve test coverage."""
...
def main():
    """Run all simplified coverage tests."""
    print("Running Simplified Coverage Tests")
    print("=" * 60)
    
    # List of simplified test files to run
    test_files = [
        "tests/unit/test_main_simple_coverage.py",
        "tests/unit/test_config_simple_coverage.py", 
        "tests/unit/test_diff_parser_simple_coverage.py",
        "tests/unit/test_analyzer_simple_coverage.py",
        "tests/unit/test_report_simple_coverage.py"
    ]
    ...
    if failed == 0:
        ...
        try:
            coverage_result = subprocess.run([
                ...
                "--cov-report=xml:coverage_simple.xml",
        ...
        print(f"\n❌ {failed} test(s) failed. Please fix them before running coverage analysis.")
        return 1
