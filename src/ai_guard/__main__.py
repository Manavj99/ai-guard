...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="AI-Guard: Smart Code Quality Gatekeeper")
    parser.add_argument(
        "--min-cov",
        type=int,
        help="Override min coverage percentage"
    )
    parser.add_argument(
        "--skip-tests",
        action="store_true",
    ...
    analyzer_args = [
        "--report-format", args.report_format,
