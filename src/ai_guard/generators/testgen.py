...
from ..diff_parser import changed_python_files, parse_github_event
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Generate speculative tests for changed code")
    parser.add_argument("--event", help="Path to GitHub event JSON file")
    parser.add_argument("--output", default="tests/unit/test_generated.py",
